...
**Tier:** 100 — Recognize | **Arc:** Standalone | **Prereqs:** 1114, 1115, 1116 | **Episode:** 9
...
**What Next:** Read 223 (Form Design Method) for the structured approach to designing a form from scratch using these principles. Read 1118 (Empty States) and 1119 (Error States) for the two moments in form flows that most commonly receive the least design attention and produce the most friction.
