# What a Prototype Is
**Tier:** 100 — Recognize | **Arc:** Standalone | **Prereqs:** 103 (Attachment Is the Real Risk), 132 (Prototype Fidelity) | **Note:** Foundational for all 309 prototyping arc pieces; pairs with 178 (Prototype vs. MVP)
...
The question is the prototype. Everything else is the form it takes.

The cost piece matters, not just for practical reasons. Buxton (2007) described the purpose of prototyping as experiencing a system before it's real — before you've arrived at a final design, much less built it. Underneath that: "finding out" and "building" are two different activities with two different cost structures. Paying the finding-out cost at the cheapest possible fidelity, before paying the building cost, is almost always the better sequence. A prototype that costs 80% of the production build to produce hasn't found out anything cheaply. It's a bet with most of the chips already on the table.

---

You'll recognize a prototype by whether the team can name the question before they name the artifact. Not a vague area of exploration. The specific thing the artifact is built to reveal. "We're building this to find out whether users understand the pricing model before they get to checkout" has a question in it. "We're building something to show stakeholders what this will look like" doesn't. One is built to discover. The other is built to illustrate. The same click-through can be either, depending on what the team needed when they started.

The checkable signal: the question was written down before building started. If the purpose is "show" rather than "find out," the artifact doesn't have a job yet. Showing it without a job will do something you probably didn't intend.
...
When you're ready to choose the form your prototype takes, 132 (Prototype Fidelity) covers how fidelity level affects what feedback you get, and how to match fidelity to the question you're asking. From there, the 309 arc walks through specific approaches for different kinds of questions. If you're working out where a prototype ends and a first shippable version begins, 178 (Prototype vs. MVP) draws that line.
