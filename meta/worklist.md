...
|---|---|---|
| ✅ | ready | write-piece skill run complete — publish.md exists |
| 📝 | draft | prose exists, no publish.md — queue for skill run |
| 🔲 | gap | no file exists — needs full draft before skill run |
| 🚫 | blocked | hard dependency unmet — do not queue |
| ⬜ | placeholder | stub file only — needs prose first |

---

## Done

| Step | # | Tier | Title | File |
|---|---|---|---|---|
| 1 | 106 | T100 | Sketching / Quick Visualization | [100-foundations/106-sketching-visualization.md](../100-foundations/106-sketching-visualization.md) |
| 2 | 132 | T100 | Prototype Fidelity | [100-foundations/132-prototype-fidelity.md](../100-foundations/132-prototype-fidelity.md) |
| 3 | 103 | T100 | Attachment Is the Real Risk | [100-foundations/103-attachment-is-the-real-risk.md](../100-foundations/103-attachment-is-the-real-risk.md) |
| 4 | 177 | T100 | What a Prototype Is | [100-foundations/177-what-a-prototype-is.md](../100-foundations/177-what-a-prototype-is.md) |

---

## Active Queue

Run in order. Each item: invoke write-piece skill → confirm publish.md written → mark done → next.
