...
## TIER 100 — Atomic Foundations (Recognize)
*Learner state: develop the ability to notice these concepts in real situations. No prior experience required.*

1. Assumption vs. Fact [DRAFTED — 100-foundations/100-assumption-vs-fact.md]
2. Not All Assumptions Are Equal (impact × uncertainty) [DRAFTED — 100-foundations/101-not-all-assumptions-equal.md]
3. Bias Is Just an Assumption You Don't Know You're Making [DRAFTED — 100-foundations/102-bias-as-assumption.md]
4. Attachment Is the Real Risk, Not the Starting Point [DRAFTED — 100-foundations/103-attachment-is-the-real-risk.md]
5. Your Derisking Toolkit (preview) [DRAFTED — 100-foundations/104-derisking-toolkit.md — also serves as Tier 300 synthesis piece]
6. Iteration — Why the First Version Isn't the Point [DRAFTED — 100-foundations/105-iteration.md]
7. Sketching / Quick Visualization [DRAFTED — 100-foundations/106-sketching-visualization.md]
8. Framing the Problem (turning a vague ask into a crisp statement) [DRAFTED — 100-foundations/107-framing-the-problem.md]
9. Five Whys [DRAFTED — 100-foundations/108-five-whys.md]
10. Weighing Trade-offs Generally (impact vs. effort) [DRAFTED — 100-foundations/109-weighing-tradeoffs.md]
11. Constraints as Design Input [DRAFTED — 100-foundations/110-constraints-as-design-input.md]
12. Self-Critique Without Another Person Available [DRAFTED — 100-foundations/111-self-critique.md]
13. Knowing When It's "Good Enough" [DRAFTED — 100-foundations/112-knowing-when-good-enough.md]
14. Defining Success Before You Start [DRAFTED — 100-foundations/113-defining-success.md]
15. Time-boxing as a Constraint-Setting Method [DRAFTED — 100-foundations/114-time-boxing.md]
16. Start With Your Proto-Persona [DRAFTED — 300-systems/301-from-vague-ask-to-real-persona.md, Part 1 (single source)]
17. A Role Is Not a Persona [DRAFTED — 300-systems/301-from-vague-ask-to-real-persona.md, Part 2 (single source)]
18. Giving and Receiving Feedback (mechanics) [DRAFTED — 100-foundations/115-giving-receiving-feedback.md]
19. Vocabulary / Shared-Definition Checks [DRAFTED — 300-systems/303-one-feature-three-handoffs.md, Part 1 (single source)]
20. Error States as a Trust System [DRAFTED — 100-foundations/116-error-states.md]
21. Empty States [DRAFTED — 100-foundations/117-empty-states.md]
22. Edge and Boundary States [DRAFTED — 100-foundations/118-edge-boundary-states.md]
23. Progressive Disclosure [DRAFTED — 100-foundations/119-progressive-disclosure.md]
24. Performance and Perceived Speed [DRAFTED — 100-foundations/120-performance-perceived-speed.md]
25. Environment Setup for Discovery Work in Cursor [DRAFTED — 100-foundations/121-environment-setup-cursor.md]
26. Starting Questions [DRAFTED — 100-foundations/122-starting-questions.md — standalone; pairs with 107, 109, 110, 113, 303 Pt 1]
27. What Usability Testing Is [DRAFTED — 100-foundations/123-what-usability-testing-is.md — standalone; no prereqs; foundation for 215]
28. Nielsen's 10 Heuristics [DRAFTED — 100-foundations/124-nielsens-heuristics.md — standalone; no prereqs; foundation for 216]
29. Jobs-to-Be-Done [DRAFTED — 100-foundations/125-jobs-to-be-done.md — standalone; no prereqs; pairs with 107, 122, 301]
30. Mental Models [DRAFTED — 100-foundations/126-mental-models.md — standalone; no prereqs; pairs with 107, 204]
31. Storyboarding [DRAFTED — 100-foundations/127-storyboarding.md — standalone; prereq: 106; pairs with 130, 132]
32. How Might We Questions [DRAFTED — 100-foundations/128-how-might-we.md — standalone; prereq: 107; bridges to 203]
33. Stakeholder Mapping [DRAFTED — 100-foundations/129-stakeholder-mapping.md — standalone; no prereqs; pairs with 304, 303]
34. Scenario Writing [DRAFTED — 100-foundations/130-scenario-writing.md — standalone; no prereqs; pairs with 125, 301, 127]
35. Question Design / Question Bias [DRAFTED — 100-foundations/131-question-design.md — standalone; no prereqs; foundational for 202]
36. Prototype Fidelity [DRAFTED — 100-foundations/132-prototype-fidelity.md — standalone; prereq: 106; precedes 215; pairs with 147]
37. Visual Hierarchy [DRAFTED — 100-foundations/133-visual-hierarchy.md — standalone; no prereqs; foundational for 119, 204, 205]
38. Design Debt (the Concept) [DRAFTED — 100-foundations/134-design-debt-concept.md — standalone; no prereqs; precedes 300 arc]
39. Leading vs. Lagging Indicators [DRAFTED — 100-foundations/135-leading-lagging-indicators.md — standalone; prereq: 113; precedes 217]
40. Critique vs. Feedback [DRAFTED — 100-foundations/136-critique-vs-feedback.md — standalone; no prereqs; pairs with 115]
41. AI as Execution Partner [DRAFTED — 100-foundations/147-ai-as-execution-partner.md — standalone; no prereqs; foundational for all AI workflow pieces (200, 201, 302, 308)]

**Phase 1-2 atoms (148–176) — all DRAFTED:**
42. Primary vs. Secondary Research [DRAFTED — 100-foundations/148-primary-vs-secondary-research.md — prereq for 202 arc]
43. Research vs. Anecdote [DRAFTED — 100-foundations/149-research-vs-anecdote.md — pairs with 148, 150]
44. Pattern vs. Data Point [DRAFTED — 100-foundations/150-pattern-vs-data-point.md — prereq for 202 arc, 214]
45. Self-Report vs. Observed Behavior [DRAFTED — 100-foundations/151-self-report-vs-observed-behavior.md — prereq for 202 arc, 301]
46. Behavior vs. Attitude [DRAFTED — 100-foundations/152-behavior-vs-attitude.md — prereq for 202 arc, 214, 301]
47. Experience vs. Process [DRAFTED — 100-foundations/153-experience-vs-process.md — prereq for all 206 pieces]
48. What a Pain Point Is [DRAFTED — 100-foundations/154-what-a-pain-point-is.md — prereq for all 206 pieces]
49. Synthesis vs. Analysis [DRAFTED — 100-foundations/155-synthesis-vs-analysis.md — prereq for 214]
50. Name What People Do, Not What They Think [DRAFTED — 100-foundations/156-name-what-people-do-not-what-they-think.md — prereq: 151; prereq for 202c, 214]
51. Why You Don't Help During Testing [DRAFTED — 100-foundations/157-why-you-dont-help-during-testing.md — prereq for 215a, 215b]
52. Task Statement Design [DRAFTED — 100-foundations/158-task-statement-design.md — prereq for 215a, 215b]
53. Observation Effect [DRAFTED — 100-foundations/159-observation-effect.md — soft prereq for 215a]
54. What a Baseline Is [DRAFTED — 100-foundations/160-what-a-baseline-is.md — soft prereq for 217]
55. Metric vs. Measure [DRAFTED — 100-foundations/161-metric-vs-measure.md — soft prereq for 217]
56. The Interpretation Gap [DRAFTED — 100-foundations/162-the-interpretation-gap.md — prereq for 303]
57. Alignment vs. Consensus [DRAFTED — 100-foundations/163-alignment-vs-consensus.md — prereq for 304]
58. Generative vs. Convergent Thinking [DRAFTED — 100-foundations/164-generative-vs-convergent-thinking.md — prereq for 304, 203]
59. Frontstage and Backstage [DRAFTED — 100-foundations/165-frontstage-and-backstage.md — prereq for 306]
60. Default as a Design Decision [DRAFTED — 100-foundations/166-default-as-a-design-decision.md — soft prereq for 307]
61. Automation Bias and Calibrated Trust [DRAFTED — 100-foundations/167-automation-bias-and-calibrated-trust.md — prereq for 302, 308]
62. Explainability vs. Transparency in AI [DRAFTED — 100-foundations/168-explainability-vs-transparency-in-ai.md — prereq for 302, 308]
63. Affordance [DRAFTED — 100-foundations/169-affordance.md — prereq for 302, 308]
64. Exploratory vs. Explanatory Visualization [DRAFTED — 100-foundations/170-exploratory-vs-explanatory-visualization.md — soft prereq for 212]
65. Interface Copy vs. Marketing Copy [DRAFTED — 100-foundations/171-interface-copy-vs-marketing-copy.md — soft prereq for 205]
66. Browse vs. Search [DRAFTED — 100-foundations/172-browse-vs-search.md — soft prereq for 204, 218]
67. Empathy as Cognitive Simulation [DRAFTED — 100-foundations/173-empathy-as-cognitive-simulation.md — prereq for 301, 301c]
68. Think-Aloud Protocol [DRAFTED — 100-foundations/174-think-aloud-protocol.md — prereq for 215a]
69. What a Journey Map Is [DRAFTED — 100-foundations/175-what-a-journey-map-is.md — prereq for all 206 pieces]
70. Swimlanes as a Comparison Tool [DRAFTED — 100-foundations/176-swimlanes-as-a-comparison-tool.md — prereq for enterprise journey mapping]
71. What a Prototype Is [DRAFTED — 100-foundations/177-what-a-prototype-is.md — prereqs: 103, 132; foundational for all 309 arc pieces; elevated to world-class depth 2026-08-10]
72. Prototype vs. MVP [DRAFTED — 100-foundations/178-prototype-vs-mvp.md — prereqs: 177, 105; foundational for all 309 arc pieces; elevated to world-class depth 2026-08-10]
73. What a Content Model Is [DRAFTED — 100-foundations/179-what-a-content-model-is.md — gateway atom for all content architecture work; no prereqs]
74. Content Types and Attributes [DRAFTED — 100-foundations/180-content-types-and-attributes.md — prereqs: 179; every attribute is a capability]
75. Structured vs. Unstructured Content [DRAFTED — 100-foundations/181-structured-vs-unstructured-content.md — prereqs: 179, 180; flexibility paradox]
76. The Bolt-On Cost [DRAFTED — 100-foundations/182-bolt-on-cost.md — prereqs: 179, 180, 181; most important content architecture atom]
77. Classification Decisions Compound [DRAFTED — 100-foundations/183-classification-decisions-compound.md — prereqs: 179, 182; names as structural commitments]
78. Labeling Systems in IA [DRAFTED — 100-foundations/184-labeling-systems.md — prereqs: 183; navigation as model-user alignment]
79. Metadata as Design [DRAFTED — 100-foundations/185-metadata-as-design.md — prereqs: 180, 182; every metadata attribute is a system capability]
80. Taxonomy Design Basics [DRAFTED — 100-foundations/186-taxonomy-design-basics.md — prereqs: 183, 184; org-facing vs. user-facing taxonomy]
81. Layout Principles — Proximity, Alignment, Repetition, Contrast [DRAFTED — 100-foundations/187-layout-principles.md — no prereqs; visual craft foundation]
82. Gestalt Principles [DRAFTED — 100-foundations/188-gestalt-principles.md — prereqs: 187; perceptual mechanisms beneath layout]
83. Whitespace as Signal [DRAFTED — 100-foundations/189-whitespace-as-signal.md — prereqs: 187, 188; empty space is signal, not absence]
84. Reading Patterns (F-pattern, Z-pattern) [DRAFTED — 100-foundations/190-reading-patterns.md — prereqs: 188; "it's on the page" ≠ "users find it"]
85. Typography as Hierarchy [DRAFTED — 100-foundations/191-typography-as-hierarchy.md — prereqs: 187, 190; scale/weight/contrast as hierarchy tree]
86. Color as Communication [DRAFTED — 100-foundations/192-color-as-communication.md — prereqs: 187; semantic vs. aesthetic; accessibility as second signal]
87. Decision Inventory [DRAFTED — 100-foundations/193-decision-inventory.md — no prereqs; invisible decisions are still decisions]
88. Three Constraint Types [DRAFTED — 100-foundations/194-three-constraint-types.md — prereqs: 193; inherited / configurable / immovable]
89. Design System as Encoded Model [DRAFTED — 100-foundations/195-design-system-as-encoded-model.md — prereqs: 179, 194; components embed assumptions]
90. Where Design Systems Fail [DRAFTED — 100-foundations/196-where-design-systems-fail.md — prereqs: 195, 194; two failure signals]
...
## TIER 200 — Methods (Practice)
*Learner state: develop a repeatable practice with named steps and a concrete output. Builds on Tier 100 foundations.*

1. Flagging Design Debt As You Go [DRAFTED — 300-systems/300-cost-you-dont-see-and-flagging-debt.md, Parts 4-6 (full arc kept together in 300-systems; method is Parts 4-6)]
2. Story Mapping in Cursor [DRAFTED — 200-methods/200-story-mapping-in-cursor.md — tool policy note added]
3. Grooming with AI [DRAFTED — 200-methods/201-grooming-with-ai.md]
4. Research Mechanics (arc) [DRAFTED — arc: 202-research-arc.md + 202a/202b/202c; old 202 file is redirect stub]
   - 4a. Conversational Interview [DRAFTED — 200-methods/202a-conversational-interview.md — prereqs: 115, 131, 151, 152]
   - 4b. Remote / Async Research [DRAFTED — 200-methods/202b-remote-async-research.md — prereqs: 115, 131, 151, 152]
   - 4c. Observational Research [DRAFTED — 200-methods/202c-observational-research.md — prereqs: 115, 151, 152, 156]
5. Structured Ideation / Crazy 8s [DRAFTED — 200-methods/203-structured-ideation-crazy8s.md — pre-converged constraint added]
6. Information Architecture (two approaches) [DRAFTED — 204a/204b; old 204 is redirect stub]
   - 6a. Task-Based IA [DRAFTED — 200-methods/204a-task-based-ia.md — prereqs: 119, 133]
   - 6b. Content-Based IA [DRAFTED — 200-methods/204b-content-based-ia.md — prereqs: 119, 133]
7. Content Design / UX Writing [DRAFTED — 200-methods/205-content-design-ux-writing.md]
8. Journey Mapping (arc) [DRAFTED — arc: 206-journey-mapping-arc.md + 206a/206b/206c; old 206 is redirect stub]
   - 8a. Assumption-First Proto-Map [DRAFTED — 200-methods/206c-assumption-first-proto-map.md — prereqs: 175, 153, 154]
   - 8b. Discovery-Driven Journey Map [DRAFTED — 200-methods/206a-discovery-driven-journey-map.md — prereqs: 175, 153, 154, 151]
   - 8c. Co-Creative Journey Map [DRAFTED — 200-methods/206b-co-creative-journey-map.md — prereqs: 175, 153, 154, 163, 164]
9. Premortem [DRAFTED — 200-methods/207-premortem.md]
10. Five-Second Test / First-Click Test [DRAFTED — 200-methods/208-five-second-test.md]
11. Design Decision Records [DRAFTED — 200-methods/209-design-decision-records.md]
12. Retrospective for Design Decisions [DRAFTED — 200-methods/210-retrospective-design-decisions.md]
13. Quick Competitive/Comparative Scan [DRAFTED — 200-methods/211-quick-comparative-scan.md]
14. Data Visualization for Decision-Makers [DRAFTED — 200-methods/212-data-visualization.md]
15. A Practitioner's Checklist for Accessible Enterprise Forms [DRAFTED — 200-methods/213-accessibility-forms-checklist.md]
16. Affinity Mapping [DRAFTED — 200-methods/214-affinity-mapping.md — prereqs: 155, 156; enterprise scale section added]
17. Usability Testing (two approaches) [DRAFTED — 215a/215b; old 215 is redirect stub]
    - 17a. Moderated Usability Session [DRAFTED — 200-methods/215a-moderated-usability-session.md — prereqs: 123, 113, 157, 158, 174]
    - 17b. Unmoderated Usability Testing [DRAFTED — 200-methods/215b-unmoderated-usability-testing.md — prereqs: 123, 113, 157, 158]
18. Heuristic Evaluation [DRAFTED — 200-methods/216-heuristic-evaluation.md — prereq: 124]
19. UX Metrics [DRAFTED — 200-methods/217-ux-metrics.md — prereq: 113; soft prereqs: 160, 161]
20. Card Sorting for IA Validation [DRAFTED — 200-methods/218-card-sorting.md — prereq: 204 arc]
21. AI for Design Work [DRAFTED — 200-methods/219-ai-for-design-work.md — prereq: 147; foundation for all AI path elements]
22. Working in Vendor Software [DRAFTED — 200-methods/220-working-in-vendor-software.md — prereq: 134; non-custom dev audience]
23. Assumption-First Proto-Persona [DRAFTED — 300-systems/301c-assumption-first-proto-persona.md — prereqs: 173, 151, 152; companion to 301 arc]
...
## TIER 300 — Systems (Orchestrate)
*Learner state: develop judgment about when and how to combine methods in complex situations. Requires having encountered the problems these arcs address.*

1. The Cost You Don't See → Flagging Design Debt (full arc) [DRAFTED — 300-systems/300-cost-you-dont-see-and-flagging-debt.md]
2. From a Vague Ask to a Real Persona (full arc) [DRAFTED — 300-systems/301-from-vague-ask-to-real-persona.md]
3. Spotting AI Surprises → Mocking and Testing an Agent Handoff (full arc) [DRAFTED — 300-systems/302-spotting-ai-surprises-and-agent-handoff.md]
4. One Feature, Three Handoffs [DRAFTED — 300-systems/303-one-feature-three-handoffs.md]
5. Running One Workshop, Start to Finish [DRAFTED — 300-systems/304-running-one-workshop.md]
6. The Derisking Toolkit as a Whole [DRAFTED — 100-foundations/104-derisking-toolkit.md (also Tier 100 foundational arc Part 5)]
7. Generalized "Did It Work" Follow-Up Habit [DRAFTED — 300-systems/305-generalized-did-it-work.md]
...
## Standalone Thread (loose, no tier-sequencing required, all 100-level craft topics)
Desire Paths as Literal User Research [standalone/desire-paths-user-research.md] · Broken Windows and the One Unfixed Thing [standalone/broken-windows.md] · Tragedy of the Commons and Shared Design Systems [standalone/tragedy-of-commons.md] · Film Review Culture for Design Critique [standalone/film-review-critique.md]

---

## Reading This Outline
- All items are now [DRAFTED]. The tier-remaining files (11/12/13) have been dissolved into individual files in the tiered folders.
- Dependencies point downward: a 300-level item's dependencies should exist (drafted or at least gapped) at 100/200 before the 300 piece is considered complete.
- Note: "Flagging Design Debt" (Tier 200) and "Spotting AI Surprises" + "Mocking Agent Handoff" (both Tier 200) are kept in 300-systems/ as part of their full arcs. 301c (Assumption-First Proto-Persona) also lives in 300-systems/ as a companion to the 301 arc. See STATUS.md for full tracking.
- FORMAT UPGRADE PENDING: All 56 original pieces (100–122, 200–213, 300–307, standalone) need Goal, Try This, and What Next elements added to match the amended spec. New pieces (123–136, 147, 148–176, 202 arc, 204a/b, 206 arc, 214–220, 308) are already in amended spec format.
- LEARNER MATURITY LABELS: Tier 100 = Recognize, Tier 200 = Practice, Tier 300 = Orchestrate. These are learner-state labels, not just content complexity. Each tier is optimized for a different entry state.
- META: Audience orientation guides (meta/16–18) and Deep Context pieces (meta/deep-context/) added as non-published reference material.
- PHASE 1-2 AUDIT: Four methods restructured as arc clusters (202, 206, 204 two-approach, 215 two-approach); all 9 Tier 300 arcs revised for constraint paths and enterprise scale; 29 new atoms (148–176); 3 new standalone methods (219, 220, 301c). Sequencing governed by meta/14-ordering-guide.md (v2.0). Quality standard: meta/phase0-audit-table.md.
